...
**คอมโพเนนต์แสดงผลรูปภาพ Image:** คอมโพเนนต์ Image มีหน้าที่แสดงผลรูปภาพในโปรเจกต์ ทั้งภาพภายในเครื่องผ่าน require() และภาพจากอินเทอร์เน็ตผ่านพร็อพส์ uri โดยสำหรับการโหลดภาพออนไลน์นั้นมีข้อบังคับสำคัญคือต้องกำหนดความกว้างและความสูงไว้เสมอมิฉะนั้นภาพจะไม่แสดง และสามารถปรับการจัดวางองค์ประกอบด้วย resizeMode เช่น cover, contain, stretch หรือ center เพื่อรักษาสัดส่วนหรือปรับรูปลักษณ์ตามความเหมาะสม

**คอมโพเนนต์รับข้อมูลข้อความ TextInput และการควบคุมคีย์บอร์ด:** คอมโพเนนต์ TextInput เป็นเครื่องมือหลักในการสร้างฟอร์มเพื่อรับข้อมูลข้อความจากผู้ใช้งานผ่านคีย์บอร์ด โดยมีพร็อพส์สำคัญ เช่น value, placeholder, secureTextEntry สำหรับการป้อนรหัสผ่าน และ onChangeText สำหรับคอยดึงข้อมูลการพิมพ์ล่าสุด นอกจากนี้เรายังสามารถเลือกรูปแบบคีย์บอร์ดให้เหมาะกับประเภทการรับค่าได้ด้วย keyboardType รวมถึงการปรับค่า autoCapitalize และ returnKeyType เพื่อให้การตอบสนองดีที่สุด

**การสร้างพื้นที่เลื่อนดูข้อมูลด้วย ScrollView เปรียบเทียบกับ View:** แม้ว่า View จะเรนเดอร์ข้อมูลได้รวดเร็วและใช้ในการจัดวางโครงสร้างทั่วไป แต่หากข้อมูลหน้าจอยาวเกินขอบเขตจอภาพก็จะไม่สามารถเลื่อนอ่านได้ ซึ่ง ScrollView จะเข้ามาช่วยแก้ปัญหาและอำนวยความสะดวกในการเลื่อนเนื้อหาแนวตั้งหรือแนวนอน โดยการจัดระยะห่าง (Padding) หรือขอบเขตการจัดตำแหน่งของเนื้อหาภายในจำลองจะต้องใช้งานผ่านพร็อพส์ contentContainerStyle แทนสไตล์ปกติ

**การจัดการเหตุการณ์การสัมผัสและการกดปุ่มด้วย Pressable:** คอมโพเนนต์ Pressable เป็นเครื่องมือยุคใหม่ที่ถูกพัฒนาต่อยอดขึ้นมาเพื่อตรวจจับเหตุการณ์การกดและสัมผัสแบบซับซ้อน เช่น onPress, onLongPress, onPressIn และ onPressOut โดยผู้พัฒนาสามารถเขียนประกาศฟังก์ชันแบบไดนามิกผ่านพารามิเตอร์ของ `{ pressed }` เพื่อสร้างลวดลายและการตอบสนองของปุ่มเมื่อถูกกดสัมผัสในแบบเรียลไทม์ได้อย่างยืดหยุ่น

**การหลีกเลี่ยงพื้นที่ขอบจอด้วย SafeAreaView:** SafeAreaView เป็นคอมโพเนนต์สำคัญในการจัดแจงขอบเขตหน้าจอเพื่อช่วยคำนวณและเว้นพื้นที่ว่างในส่วนของรอยบากหน้าจอ แถบกล้อง หรือแถบนำทางระบบปฏิบัติการโดยเฉพาะบนเครื่อง iOS เพื่อให้เนื้อหาหลักของแอปพลิเคชันไม่ถูกรบกวนหรือทับซ้อนและได้รับการจัดระเบียบตามระยะปลอดภัยของมือถือแต่ละรุ่นอย่างเหมาะสม

**แนวคิดการสร้าง Custom Component และการกำหนด Props Interface ด้วย TypeScript:** การพัฒนาแอปพลิเคชันให้สามารถนำส่วนประกอบ UI มารีไซเคิลใหม่ทำได้โดยการแยกชิ้นส่วนไปเขียนเป็น Custom Component และส่งผ่านตัวแปรต่าง ๆ ผ่านระบบ Props โดยมีการใช้ TypeScript Interface ในการควบคุมความปลอดภัยเพื่อกำหนดความต้องการข้อมูลประเภทจำเพาะ เช่น การใส่เครื่องหมาย ? กำหนดตัวแปรแบบเป็นทางเลือก และฟังก์ชัน Callback สำหรับส่งสัญญานเมื่อเกิดการสัมผัสอินเทอร์เฟซย่อย
