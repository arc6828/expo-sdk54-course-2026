...
## 13.8 สรุปท้ายบทเรียน

**เทคนิคการตรวจสอบและแก้ไขข้อผิดพลาดใน Expo SDK 54:** กระบวนการตรวจหาและดีบั๊กข้อผิดพลาดใน Expo SDK 54 สามารถใช้ Expo Developer Menu ในการสั่งรีโหลดหน้าจอหรือเปิดระบบ Inspector โดยสามารถเรียกใช้งานผ่านคีย์บอร์ด m ในเครื่องจำลองหรือการเขย่าอุปกรณ์จริง และสามารถเชื่อมโยงคำสั่ง JavaScript เข้ากับ Chrome Developer Tools ผ่านการทริกเกอร์ j ในคอมพิวเตอร์เพื่อเปิดหน้าต่างตรวจสอบ Console บันทึกสเตตัสและใส่จุดหยุดทำงานได้อย่างละเอียด

**สถาปัตยกรรมและหลักการของ Expo Application Services (EAS):** บริการ EAS Build คลาวด์อำนวยความสะดวกในการจัดทำไฟล์ติดตั้งเนทีฟสำเร็จรูปให้ผู้พัฒนาโดยแก้ปัญหาความยุ่งยากของการจัดตั้งเครื่อง Android SDK หรือความจำเป็นต้องมีเครื่อง Mac ในการคอมไพล์ระบบ iOS โดยระบบจะนำซอร์สโค้ดไปประกอบและจัดการคีย์ความปลอดภัยของแอปพลิเคชัน (Signing Credentials) บนคลาวด์เซิร์ฟเวอร์ความเร็วสูงให้โดยอัตโนมัติ

**การจัดเตรียมความพร้อมแอปพลิเคชันใน app.json:** ก่อนส่งมอบโค้ดไปประกอบไฟล์ติดตั้งระดับเนทีฟ ผู้พัฒนาจำเป็นต้องระบุคุณสมบัติตัวตนของแอปพลิเคชันในไฟล์ app.json เช่น ชื่อแอป เวอร์ชันของรุ่น ที่อยู่ของรูปไอคอนและภาพต้อนรับตอนเริ่มแอป รวมถึงการตั้งรหัสผ่านชุดจดทะเบียนที่ห้ามซ้ำกันเด็ดขาดในระดับสากลอย่าง android.package และ ios.bundleIdentifier

**การตั้งค่าโปรไฟล์การคอมไพล์ใน eas.json:** ไฟล์ eas.json ใช้สำหรับระบุเป้าหมายและขั้นตอนพฤติกรรมการบิลด์แอปพลิเคชัน โดยเราเขียนปรับแต่งให้แยกประเภทโปรไฟล์ได้ เช่น โปรไฟล์ development เพื่อสร้างไคลเอนต์ทดสอบในทีม, โปรไฟล์ preview ที่บังคับคอมไพล์ออกมาเป็นไฟล์ติดตั้ง .apk โดยตรงสำหรับเครื่อง Android และโปรไฟล์ production เพื่อสร้างไฟล์ติดตั้งมาตรฐานในการส่งตัวแอปเตรียมยื่นขึ้นร้านค้าอย่างเป็นทางการ

**ขั้นตอนการสั่งรันคอมไพล์ด้วยคำสั่ง EAS CLI:** ลำดับการสั่งประกอบแอปเริ่มจากติดตั้ง eas-cli และทำรายการล็อกอินด้วยคำสั่ง eas login จากนั้นจึงยิงคำสั่งคอมไพล์หลักตามโปรไฟล์ที่ตั้งค่าไว้ ซึ่งระบบจะนำรหัสโค้ดฝั่งไคลเอนต์ขึ้นประมวลผลบนเซิร์ฟเวอร์คลาวด์ของ Expo และแสดงที่อยู่ลิงก์และ QR Code บนหน้าต่างเทอร์มินัลเพื่อให้ผู้พัฒนาดาวน์โหลดไฟล์ไบนารี .apk มาลงตรวจสอบความเรียบร้อยบนโทรศัพท์จริงได้

**แนวทางและกระบวนการเผยแพร่แอปขึ้น App Stores:** กระบวนการยื่นแอปขึ้นร้านค้าทำได้โดยบิลด์โปรไฟล์การผลิตเพื่อให้ได้ไฟล์ .aab สำหรับ Android หรือไฟล์ .ipa สำหรับ iOS เพื่อเตรียมยื่นขอขึ้นร้านค้าอย่างเป็นทางการผ่านบัญชี Google Play Console หรือ Apple Developer Program โดยใช้เครื่องมือส่งเอกสารผ่านเว็บบอร์ดหรือสั่งงานอย่างสะดวกผ่านระบบจัดส่งอัตโนมัติด้วยคำสั่ง eas submit

**ขั้นตอนการอัปเกรดเวอร์ชันของ Expo SDK:** การปรับแต่งและขยับรุ่นโปรเจกต์ให้มีประสิทธิภาพและมีความปลอดภัยสูงสุดตามรุ่น SDK ล่าสุด ทำได้โดยติดตั้งตัวแกนหลัก expo รุ่นใหม่ จากนั้นสั่งทำงาน npx expo install --fix เพื่อปรับปรุงรุ่นไลบรารีอื่น ๆ ทั้งระบบให้มีความเข้ากันและผ่านการรับรองความเสถียร พร้อมทั้งบังคับล้างประวัติแคชรัน Metro ด้วย npx expo start -c เพื่อเคลียร์ไฟล์เก่าไม่ให้ระบบทำงานขัดข้อง
